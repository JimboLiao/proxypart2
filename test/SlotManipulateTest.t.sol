...
contract SlotManipulateTest is Test {
    ...
    function testValueSet() public {
        ...
        assertEq(uint256(vm.load(address(instance), keccak256("appworks.week8"))), 2023_4_27);
    }
    ...
    function testSetProxyImplementation() public {
        ...
        assertEq(bytes32ToAddress(vm.load(address(instance), implementationSlot)), randomAddress);
    }
    ...
    function testSetBeaconImplementation() public {
        ...
        assertEq(bytes32ToAddress(vm.load(address(instance), beaconImplementationSlot)), randomAddress);
    }
    ...
    function testSetAdminImplementation() public {
        ...
        assertEq(bytes32ToAddress(vm.load(address(instance), adminAddressSlot)), randomAddress);
    }
    ...
    function testSetProxiableImplementation() public {
        ...
        assertEq(bytes32ToAddress(vm.load(address(instance), proxiableImplementationSlot)), randomAddress);
    }
}
